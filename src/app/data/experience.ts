...
export const experience: ExperienceItem[] = [
    ...
    }, 
    {
        ...
        location: "Dallas, TX",
        description: "Software engineer on the Auto Quoting Permissions team. Built an internal permissions tool with React and DynamoDB to streamline quoting workflows. Automated deployments and web delivery to 1000 agents with Terraform and AWS.",
